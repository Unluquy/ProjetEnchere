...
public class ServletInscription extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (pseudoSaisie.length() != 0 && prenomSaisie.length() != 0 && nomSaisie.length()
                != 0 && emailSaisie.length() != 0 && rueSaisie.length() != 0 && codePostalSaisie.length()
                != 0 && villeSaisie.length() != 0 && motDePasseSaisie.length()
                != 0 && motDePasseValidationSaisie.equals(motDePasseSaisie)){
